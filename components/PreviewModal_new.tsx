...
const PreviewModal: React.FC = () => {
  ...
  // Load markdown content hoặc code content
  useEffect(() => {
    if ((previewFile?.type === 'markdown' || previewFile?.type === 'code') && previewFile.url) {
      setIsLoading(true);
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel 
                ...
                } transform overflow-hidden bg-white dark:bg-zinc-800 text-left align-middle shadow-xl transition-all flex flex-col`}
              >
                {/* Header */}
